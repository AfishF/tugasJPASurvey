...
public class QueryAddData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Survey Ruangan Favorit Mahasiswa Teknik Komputer</title>");
            ...
            out.println("</div>");
            out.println("<div class=\"sidebar-brand-text mx-3\">Tugas JPA Survey</div>");
            out.println("</a>");
            ...
            out.println("<h2>Survey Ruangan Favorit Mahasiswa Teknik Komputer Universitas Diponegoro</h2>");
            out.println("</nav>");
            ...
            out.println("<div class=\"col-sm-6 mb-3 mb-sm-0\">");
            out.println("Selama berada di Tekkom, Ruangan mana yang anda sukai?");
            out.println("<input type=\"text\" name=\"ruangan_fav\" class=\"form-control bg-light border-0 small\" placeholder=\"Jawab disini\" aria-label=\"Search\" aria-describedby=\"basic-addon2\">");
            out.println("</div><br>");
            
            out.println("<div class=\"col-sm-6 mb-3 mb-sm-0\">");
            out.println("Sebutkan Alasan, kenapa menyukai ruangan tersebut?");
            out.println("<input type=\"text\" name=\"alasan_fav\" class=\"form-control bg-light border-0 small\" placeholder=\"Jawab disini\" aria-label=\"Search\" aria-describedby=\"basic-addon2\">");
            out.println("</div><br>");
            
            out.println("<div class=\"col-sm-6 mb-3 mb-sm-0\">");
            out.println("Selama berada di Tekkom, Ruangan mana yang anda tidak sukai?");
            out.println("<input type=\"text\" name=\"ruangan_not\" class=\"form-control bg-light border-0 small\" placeholder=\"Jawab disini\" aria-label=\"Search\" aria-describedby=\"basic-addon2\">");
            out.println("</div><br>");
            
            out.println("<div class=\"col-sm-6 mb-3 mb-sm-0\">");
            out.println("Sebutkan Alasan, kenapa tidak menyukai ruangan tersebut?");
            out.println("<input type=\"text\" name=\"alasan_not\" class=\"form-control bg-light border-0 small\" placeholder=\"Jawab disini\" aria-label=\"Search\" aria-describedby=\"basic-addon2\">");
            out.println("</div><br>");
            
            out.println("<div class=\"col-sm-6 mb-3 mb-sm-0\">");
            out.println("Berikan saran, masukkan, dan atau penilaian untuk Ruangan-ruangan yang ada di Tekkom!");
            out.println("<input type=\"text\" name=\"saran\" class=\"form-control bg-light border-0 small\" placeholder=\"Jawab disini\" aria-label=\"Search\" aria-describedby=\"basic-addon2\">");
            out.println("</div><br>");
            out.println("</div>");
            ...
            Query q = em.createNativeQuery("INSERT INTO DATA (nama, nim, angkatan, ruangan_fav, alasan_fav, ruangan_not, alasan_not, saran) VALUES(nama, nim, angkatan, ruangan_fav, alasan_fav, ruangan_not, alasan_not, saran)");
            q.setParameter(1, n1);
